...
class CrudRoutesFactory {
    ...
    setSwaggerOperation(name) {
        ...
        swagger_helper_1.Swagger.setOperation({ summary }, this.targetProto[name]);
    }
    ...
    setSwaggerResponseOk(name) {
        ...
        const responseOkMeta = swagger_helper_1.Swagger.createResponseOkMeta(status, isArray, this.modelType);
        swagger_helper_1.Swagger.setResponseOk({ ...metadata, ...responseOkMeta }, this.targetProto[name]);
    }
